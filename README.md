...
**Deployment**  
The Detection module is deployed on a Docker container, making it suitable for deployment in local environments as well as cloud-based setups and simplifying inter-component communication
